...
## Acceptance Criteria
- [x] `python app.py` exits with status code 0.
- [x] `python app.py` writes `Hello, World!` on the first line.
- [x] `python app.py` writes `Today is YYYY-MM-DD.` on the second line, matching
